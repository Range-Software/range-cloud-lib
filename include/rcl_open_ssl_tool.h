#ifndef RCL_OPEN_SSL_TOOL_H
#define RCL_OPEN_SSL_TOOL_H
...
#include "rcl_open_ssl_tool_settings.h"
...
class ROpenSslTool : public QObject
{
    ...
    public:
        ...
        //! Generate CSR (renew certificate).
        void generateCsr(const QString &keyPath, const QString &keyPassword, const QString &certPath, const QString &csrPath) const;
