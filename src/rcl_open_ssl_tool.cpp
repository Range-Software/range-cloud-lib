...
void ROpenSslTool::generateCsr(const QString &keyPath, const QString &keyPassword, const QString &certPath, const QString &csrPath) const
{
    this->generateCsr(keyPath,keyPassword,RTlsTrustStore::findSubjectFields(certPath),csrPath);
}
